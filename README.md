...
```
or, to clone a specific binary point release (for example `v4.20230830.0`)
```bash
git clone https://github.com/limine-bootloader/limine.git --branch=v4.20230830.0-binary --depth=1
```
