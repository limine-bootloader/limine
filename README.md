...
```
or, to clone a specific binary point release (for example `v6.20231227.0`)
```bash
git clone https://github.com/limine-bootloader/limine.git --branch=v6.20231227.0-binary --depth=1
```
