...
```
or, to clone a specific binary point release (for example `v5.20230917.0`)
```bash
git clone https://github.com/limine-bootloader/limine.git --branch=v5.20230917.0-binary --depth=1
```
