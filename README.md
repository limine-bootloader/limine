...
```
or, to clone a specific binary point release (for example `v3.20221007.0`)
```bash
git clone https://github.com/limine-bootloader/limine.git --branch=v3.20221007.0-binary --depth=1
```
