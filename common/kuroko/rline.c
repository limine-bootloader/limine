...
static void get_size(void) {
	rline_terminal_width = terms[0]->cols;
 ...
 */
static int handle_escape(int c) {
	switch (c) {
		case GETCHAR_CURSOR_UP:     history_previous(); break;
		case GETCHAR_CURSOR_DOWN:   history_next(); break;
		case GETCHAR_CURSOR_RIGHT:  cursor_right(); break;
		case GETCHAR_CURSOR_LEFT:   cursor_left(); break;
		case GETCHAR_HOME:          cursor_home(); break;
		case GETCHAR_END:           cursor_end(); break;
		case GETCHAR_DELETE:
